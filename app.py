...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        super().__init__()
        self.setWindowTitle('Calculator - Canganjo')
        ...
        self.add_btn(
            ...
            'background: #d5580d; color: #fff; font-weight:650;'
            )
        ...
        self.add_btn(
            ...
            'background: #1a9d13; color: #fff; font-weight:650;'
        )
        ...
        self.add_btn(
            QPushButton('='), 4, 4, 1, 1,
            self.isval,
            'background: #006158; color: #fff; font-weight:650;'
            )
